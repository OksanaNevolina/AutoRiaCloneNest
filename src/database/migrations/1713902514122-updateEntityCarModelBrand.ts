...
export class UpdateEntityCarModelBrand1713902514122
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "car" ADD "name" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "car" ADD "price" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "car" ADD "description" text NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "car" ADD "region" character varying NOT NULL`,
    );
