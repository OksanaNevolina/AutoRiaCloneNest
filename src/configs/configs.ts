...
export default (): Config => ({
  ...
  jwt: {
    sellerAccessTokenSecret: process.env.SALLER_AUTH_ACCESS_TOKEN_SECRET,
    sellerAccessTokenExpiration: parseInt(
      process.env.SALLER_AUTH_ACCESS_TOKEN_EXPIRATION,
    ),
    sellerRefreshTokenSecret: process.env.SALLER_AUTH_REFRESH_TOKEN_SECRET,
    sellerRefreshTokenExpiration: parseInt(
      process.env.SALLER_AUTH_REFRESH_TOKEN_EXPIRATION,
    ),
    ...
    forgotExpiration: parseInt(process.env.FORGOT_TOKEN_EXPIRATION),
  },
  smtp: {
    userSmtp: process.env.SMTP_USER,
    passSmtp: process.env.SMTP_PASSWORD,
  },
  frontURL: {
